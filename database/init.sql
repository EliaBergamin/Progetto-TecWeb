...
INSERT INTO Sala (nome, descrizione, img_path) VALUES
  ...
  ("{en}Pokémon{/en}", "Entra nel fantastico mondo dei {en}Pokémon{/en}, dove allenatori di tutte le età possono scoprire creature straordinarie. Esplora regioni come {ja}Kanto{/ja}, {ja}Johto{/ja} e {ja}Galar{/ja}, ammira una collezione di {en}Poké Ball{/en}, e sfida le emozionanti battaglie in un'arena virtuale. Non dimenticare di incontrare i {en}Pokémon{/en} leggendari e mitici in una sala dedicata alla loro storia e potere.", "pokemon_gallery.webp"),
