...
INSERT INTO Sala (nome, descrizione, img_path) VALUES
  ("{en}Dragon Ball{/en}", "Immergiti nell'universo epico di {en}Dragon Ball{/en}, dove potrai esplorare le avventure di {ja}Goku{/ja} e dei suoi amici. Scopri le Sfere del Drago, rivivi gli scontri leggendari contro i {ja}Saiyan{/ja}, {en}Freezer{/en} e {ja}Majin Bu{/ja}, e lasciati travolgere dall'energia delle trasformazioni Super {ja}Saiyan{/ja}. Oggetti iconici e ricostruzioni interattive ti aspettano per farti sentire parte di questa straordinaria saga.", "dragonball_grounds.webp"),
  ("Pokémon", "Entra nel fantastico mondo dei Pokémon, dove allenatori di tutte le età possono scoprire creature straordinarie. Esplora regioni come {ja}Kanto{/ja}, {ja}Johto{/ja} e {ja}Galar{/ja}, ammira una collezione di Poké {en}Ball{/en}, e sfida le emozionanti battaglie in un'arena virtuale. Non dimenticare di incontrare i Pokémon leggendari e mitici in una sala dedicata alla loro storia e potere.", "pokemon_gallery.webp"),
  ("Gormiti", "Viaggia verso l'isola magica dei Gormiti, dove la natura prende vita attraverso i potenti {en}Lord{/en} della Terra, del Mare, del Fuoco e dell'Aria. Attraversa paesaggi suggestivi e scopri la storia di questa eterna lotta tra il bene e il male. Modelli tridimensionali, effetti luminosi e una narrazione avvincente rendono questa sala un'esperienza immersiva.", "gormiti_habitat.webp"),
  ("{ja}Yu-Gi-Oh{/ja}", "Preparati a duellare nel mondo di {ja}Yu-Gi-Oh{/ja}!, dove ogni carta racconta una storia epica. Esplora il regno dei mostri con esposizioni dedicate alle carte leggendarie come il Drago Bianco Occhi Blu e il Mago Nero. Una replica dell'arena da duello ti aspetta per sfidare amici e rivivere i momenti più iconici della serie.", "yugioh_arena.webp");
...
INSERT INTO Opera (id_sala, nome, autore, descrizione, anno, img_path) VALUES
  ...
  Scopri di più su {ait}Drago Bianco Occhi Blu{/ahttps://yugipedia.com/wiki/Blue-Eyes_White_Dragon_(character)}.", 1999, "yugioh/drago_bianco_blu.webp"),
  ...
  la sua determinazione a non arrendersi mai.", 1999, "yugioh/drago_nero_rosso.webp"),
  ...
  Scopri di più su {ait}Exodia il proibito{/ahttps://yugipedia.com/wiki/Exodia_the_Forbidden_One_(character)}", 1999, "yugioh/exodia.webp"),
  ...
  Scopri di più su {ait}Mago Nero{/ahttps://virtualarena.fandom.com/it/wiki/Mago_Nero}.", 1999, "yugioh/mago_nero.webp"),
  ...
  memorie del faraone, rappresenta non solo il potere ineguagliabile, ma anche il mistero e il fascino delle civiltà perdute.", 2000, "yugioh/obelisk.webp"),
  -- pokemon
  ...
  è diventato l'emblema dei Pokémon, amato da grandi e piccoli per il suo carattere vivace e coraggioso.", 1996, "pokemon/pikachu.webp"),
  ...
  Scopri di più su {aen}Arceus{/ahttps://wiki.pokemoncentral.it/Arceus}.", 2006, "pokemon/arceus.webp"),
  ...
  Scopri di più su {aen}Gengar{/ahttps://wiki.pokemoncentral.it/Gengar}.", 1996, "pokemon/gengar.webp"),
  ...
  Scopri di più su {aen}Mewtwo{/ahttps://wiki.pokemoncentral.it/Mewtwo}.", 1996, "pokemon/mewtwo.webp"),
  ...
  Scopri di più su {ait}Zeraora{/ahttps://wiki.pokemoncentral.it/Zeraora}", 2018, "pokemon/zeraora.webp"),
  -- dragonball
  ...
  Scopri di più su {aen}Freezer{/ahttps://dragonball.fandom.com/it/wiki/Freezer}.", 1989, "dragonball/freezer.webp"),
  ...
  Scopri di più su {ait}{ja}Goku{/ja} Super {ja}Saiyan{/ja}{/ahttps://dragonball.fandom.com/it/wiki/Super_Saiyan}.", 1991, "dragonball/goku-super-saiyan.webp"),
  ...
  Scopri di più su {aja}Majin Bu{/ahttps://dragonball.fandom.com/it/wiki/Majin-Bu}.", 1994, "dragonball/majin_bu.webp"),
  ...
  Scopri di più su {aja}Shenron{/ahttps://dragonball.fandom.com/it/wiki/Shenron}.", 1986, "dragonball/shenron.webp"),
  ...
  Scopri di più su {ait}Vegeta{/ahttps://dragonball.fandom.com/it/wiki/Vegeta}.", 1989, "dragonball/vegeta.webp"),
  -- gormiti
