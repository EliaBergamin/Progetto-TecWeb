...
INSERT INTO Opera (id_sala, nome, autore, descrizione, anno, img_path) VALUES
  ...
  -- dragonball
  (1, "Freezer", "Akira Toriyama", "Freezer è uno dei villain più iconici della serie Dragon Ball, noto per la sua crudeltà e il suo potere devastante. Questo imperatore galattico spietato domina interi pianeti e razze, eliminando chiunque osi opporsi al suo dominio. Con un aspetto alieno elegante e minaccioso, Freezer è capace di trasformarsi in diverse forme, ognuna più potente della precedente. Nel cartone animato, Freezer è il principale antagonista nella saga di <a target='_blank' href='https://dragonball.fandom.com/it/wiki/Namecc'>Namek</a>, dove affronta <a target='_blank' href='https://dragonball.fandom.com/wiki/Goku'>Goku</a> e i suoi amici. La sua trasformazione finale, combinata con il suo attacco 'Disco Distruttore', rappresenta una delle battaglie più memorabili della serie. Il suo epico scontro con Goku, culminato nella trasformazione di quest'ultimo in Super Saiyan, è uno dei momenti più iconici di Dragon Ball.
  Scopri di più su <a target='_blank' href='https://dragonball.fandom.com/it/wiki/Freezer'>Freezer</a>.", 1989, "dragonball/freezer.jpg"),
  (1, "Goku Super Saiyan", "Akira Toriyama", "Goku Super Saiyan è il simbolo dell'evoluzione e della determinazione, rappresentando il culmine del potere Saiyan. Con i capelli dorati e l'aura splendente, questa trasformazione aumenta enormemente la forza e la velocità di <a target='_blank' href='https://dragonball.fandom.com/wiki/Goku'>Goku</a>, rendendolo quasi invincibile. Nel cartone animato, Goku raggiunge per la prima volta lo stato di Super Saiyan durante la battaglia contro Freezer su <a target='_blank' href='https://dragonball.fandom.com/it/wiki/Namecc'>Namek</a>, in un momento di pura disperazione e rabbia dopo la morte del suo amico <a target='_blank' href='https://dragonball.fandom.com/wiki/Krillin'>Crilin</a>. La sua trasformazione segna un punto di svolta nella serie, dimostrando il potenziale illimitato dei Saiyan. Goku utilizza questa forma in molte altre battaglie iconiche, consolidando il suo status di eroe leggendario.
