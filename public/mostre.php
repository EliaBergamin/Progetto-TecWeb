<?php
    ...
    /* MOSTRE CORRENTI*/
    $arrayMostreCorrenti = $databaseServiceIstance->selectMostreCorrenti();
    ...
    foreach ($arrayMostreCorrenti as $associativeRow){
        ...
        Templating::replaceAnchor($temp, "string_data_inizio",
                                    Templating::convertDateTimeToString($associativeRow["data_inizio"]));
        Templating::replaceAnchor($temp, "string_data_fine",
    ...
    $arrayMostreFuture = $databaseServiceIstance->selectMostreFuture();
    ...
    /* MOSTRE PASSATE*/
    $arrayMostrePassate = $databaseServiceIstance->selectMostrePassate();
