...
<body>
    ...
    <main >
        <div id="carosello">
            ...
            <button id="caroselloIndietro" type="button" aria-label="Immagine precedente" onclick="prossimaSlide(-1)">&#10094;</button>
            <button id="caroselloAvanti" type="button" aria-label="Immagine successiva" onclick="prossimaSlide(1)">&#10095;</button>
            <ol class="puntiniCarosello">
                <li>
                    <button class="" type="button" aria-label="Scorri all'immagine numero 1" onclick="currentSlide(1)">1</button>
                </li>
                <li>
                    <button class="" type="button" aria-label="Scorri all'immagine numero 2" onclick="currentSlide(2)">2</button>
                </li>
                <li>
                    <button class="" type="button" aria-label="Scorri all'immagine numero 3" onclick="currentSlide(3)">3</button>
                </li>
            </ol>
        </div>
